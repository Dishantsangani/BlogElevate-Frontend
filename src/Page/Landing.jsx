    ...
    <>
      <nav className="bg-gray-200 border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl mx-auto flex items-center justify-between p-4">
          ...
          <Link
            to="/"
            className="text-2xl font-black cursor-pointer text-gray-900 dark:text-white"
          >
            BlogElevate
          </Link>
          ...
          <div className="hidden md:flex space-x-3">
            <button
              ...
              className="rounded-xl bg-[#303B4C] px-4 py-2 text-white font-medium hover:bg-[#445877]"
            >
              Sign In
            </button>
            <button
              onClick={() => navigate("/signup")}
              className="rounded-xl border bg-white px-4 py-2 text-[#303B4C]  shadow font-medium hover:bg-white"
            >
              Sign Up
            </button>
          </div>
