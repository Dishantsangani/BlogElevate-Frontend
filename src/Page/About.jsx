    ...
    <>
      ...
      <section className="container mx-auto px-6 py-12">
        ...
        <div className="text-center lg:text-left">
          ...
          <hr className="mt-3 mb-6 border-t-2 border-gray-300 dark:border-gray-600 w-full" />
        </div>
        ...
        <div className="grid gap-10  mx-auto lg:grid-cols-2 lg:max-w-screen-lg">
          ...
          <div className="grid sm:grid-cols-3 shadow-xl">
            ...
            <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
              ...
              <p className="mb-4 text-xs text-gray-800 dark:text-gray-400">
                Product Manager
              </p>
              <p className="mb-4 text-sm tracking-wide text-gray-800 dark:text-gray-400">
