...
function Contact() {
  ...
  return (
    <>
      <Navbar />
      <section className="container mx-auto px-6 py-12 min-h-screen bg-white dark:bg-gray-900">
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">
          Contact
        </h1>
        <hr className="flex-grow border-t-2 mt-2 border-gray-300 dark:border-gray-600" />
              ...
              <div className="mt-6 space-y-8 md:mt-8">
                ...
                <p className="flex items-start -mx-2">
                  ...
                  <svg
                    ...
                    className="w-6 h-6 mx-2 text-gray-800 dark:text-gray-700"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={2}
