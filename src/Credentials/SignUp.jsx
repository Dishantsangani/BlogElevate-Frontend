...
function SignUp() {
  ...
  return (
    <>
      <div className="flex mt-15 w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800 lg:max-w-4xl">
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          <p className="mt-3 text-xl font-medium text-center text-gray-700 dark:text-gray-300">
            Welcome To
          </p>
